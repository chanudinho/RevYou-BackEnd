...
const standardQueryRouter = () => {
  router.route('/').post(standardQueryController.createStandardQuery);

  router.route('/:ProjectId').get(standardQueryController.getStandardQuery);

  router
    .route('/updateStandardQuery/:id')
